  ...
  <body>
    ...
    <div class="icons row">
      <div class="col-12 col-md-12 col-lg-4 text-center">
        <img class="imagen" src="img/servicio.png" alt="foto">
        <h2>servicio</h2>
      ...
      <div class="col-12 col-md-12 col-lg-4 text-center">
        <img class="imagen" src="img/comfort.png" alt="foto">
        <h2>comfort</h2>
        <div class="feature_divider">
        </div>
      ...
      <div class="col-12 col-md-12 col-lg-4 text-center">
        <img class="imagen" src="img/exclusividad.png" alt="foto">
        <h2>exclusividad</h2>
        <div class="feature_divider">
        </div>
    ...
    <div id="destinations" class="container-fluid">
      <div class="row">
